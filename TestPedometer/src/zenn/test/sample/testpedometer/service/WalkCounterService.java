...
public class WalkCounterService extends Service {
	public static final String TAG = MainActivity.APP_TAG+"WalkCounterService";

	public static final String ACTION = "Walk Counter Service";
	private WalkCounterMaster master;
	private DatabaseHelper db;

	public WalkCounterService() {
	}
	...
	public void onCreate() {
		...
		master = new WalkCounterMaster(manager, db);
	}
	...
	public IBinder onBind(Intent intent) {
		...
		Toast toast = Toast.makeText(getApplicationContext(), "onBind()",
				Toast.LENGTH_SHORT);
		toast.show();
		return new WalkCounterBinder(this);
	}
